...
const { Client, Collection, Events, GatewayIntentBits, Guild, PermissionsBitField, PermissionOverwriteManager } = require('discord.js')
...
async function recreateRole(roleId) {
  const guild = client.guilds.cache.get(idConfig.SERVER_ID);
